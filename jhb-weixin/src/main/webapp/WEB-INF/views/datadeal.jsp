...
<body>
    ...
    <div id="container">
        <form class="form-horizontal form-inline well search" role="form" method="post" action="/datadeal/initialize">
            <div class="form-group">
            	<label class="control-label">初始化年份</label>
            	<select name="year">
            		  <option value="2015">2015年</option>
            	</select>
                
                <button class="form-control btn btn-info" type="submit">初始化</button>
           </div>
        </form>
        
        
        <form class="form-horizontal form-inline well search" role="form" method="post" action="/datadeal/eachdeal">
            <div class="form-group">
            	<label class="control-label">数据汇总</label>
                ...
                <button class="form-control btn btn-info" type="submit">开始汇总</button>
           </div>
        </form>
        
        <form class="form-horizontal form-inline well search" role="form" method="post" action="/datadeal/alldeal">
            <div class="form-group">               
                <button class="form-control btn btn-info" type="submit">初始化 + 全部汇总</button>
           </div>
        </form>
